...
if __name__ == '__main__':
    ...
    torch_name = [
        ...
        "encoder.layer.{}.attention.output.LayerNorm.gamma",
        "encoder.layer.{}.attention.output.LayerNorm.beta",
        ...
        "encoder.layer.{}.output.LayerNorm.gamma",
        "encoder.layer.{}.output.LayerNorm.beta",
    ]
