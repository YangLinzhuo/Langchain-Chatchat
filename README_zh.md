...
* [介绍](README_zh.md#介绍)
* [解决的痛点](README_zh.md#解决的痛点)
* [快速上手](README_zh.md#快速上手)
  * [1. 环境配置](README_zh.md#1-环境配置)
  * [2. 模型下载](README_zh.md#2-模型下载)
  * [3. 初始化知识库和配置文件](README_zh.md#3-初始化知识库和配置文件)
  * [4. 一键启动](README_zh.md#4-一键启动)
  * [5. 启动界面示例](README_zh.md#5-启动界面示例)
* [联系我们](README_zh.md#联系我们)
* [合作伙伴名单](README_zh.md#合作伙伴名单)
