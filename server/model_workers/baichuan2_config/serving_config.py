...
ctx_path = '/path/to/model_full.ini'
inc_path = ['/path/to/model_inc.ini']
...
Baseconfig = EasyDict({
    ...
    'batching_strategy': 'static', # 'continuous',
...
AgentIP: str = "0.0.0.0"
ModelName: str = "baichuan2"  # internlm_7b for internlm
...
WARMUP_MODEL_INPUTS_MAP = {
    ...
    "baichuan2": baichuan2_inputs_for_warmup,
}
